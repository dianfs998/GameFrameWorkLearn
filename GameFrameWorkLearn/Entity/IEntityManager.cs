...
namespace GameFrameWork.Entity
{
    ...
    public interface IEntityManager
    {
        ...
        /// <returns>是否增加的实体组成功</returns>
        bool AddEntityGroup(string entityGroupName, float instanceAutoReleaseInterval, int instanceCapacity, int instanceExpireTime, int instancePriority, IEntityGroupHelper entityGroupHelper);
        ...
        /// 获取父实体
        /// </summary>
        /// <param name="childEntityId">子实体的编号</param>
        ...
        /// <returns>子实体的父实体</returns>
        IEntity GetParentEntity(IEntity entity);

        /// <summary>
        /// 获取子实体
        /// </summary>
        /// <param name="parentEntityId">父实体编号</param>
        /// <returns>父实体的子实体</returns>
        ...
        /// 解除子实体
        /// </summary>
        /// <param name="childEntity">子实体编号</param>
        ...
        /// </summary>
        /// <param name="entity">实体</param>
        /// <param name="locked">实体实例是否被解锁</param>
