...
namespace GameFrameWork.ObjectPool
{
    public interface IObjectPoolManager
    {
        ...
        /// <param name="capacity">对象池的容量</param>
        /// <param name="expireTime">对象池对象过期秒数</param>
        /// <returns>要创建的允许单独获取的对象池</returns>
        ...
        /// 销毁对象池
        /// </summary>
        /// <param name="objectTypem">对象类型</param>
        /// <returns>是否销毁对象池成功</returns>
        bool DestroyObjectPool(Type objectTypem);
        ...
        /// <returns>是否销毁对象池成功</returns>
        bool DestoryObjectPool<T>(string name) where T : ObjectBase;
