...
namespace GameFrameWork.DataTable
{
    ...
    public sealed class LoadDataTableDependencyAssetEventArgs : GameFrameworkEventArgs
    {
        ...
        /// </summary>
        /// <param name="dataTabelAssetName">数据表资源名称</param>
        /// <param name="dependencyAssetName">被加载的依赖资源名称</param>
        /// <param name="loadedCount">当前已加载依赖资源数量</param>
        /// <param name="totalCount">总共加载依赖资源数量</param>
        /// <param name="userData">用户自定义数据</param>
        public LoadDataTableDependencyAssetEventArgs(string dataTabelAssetName, string dependencyAssetName, 
            int loadedCount, int totalCount, object userData)
        {
            DataTableAssetName = dataTabelAssetName;
