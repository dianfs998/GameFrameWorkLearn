...
namespace GameFrameWork
{
    ...
    public class GameFrameworkException:Exception
    {
        ...
        /// <param name="innerException">抛出的异常。如果innerException参数不为空引用，则在处理内部异常的catch块中引发当前异常</param>
        ...
        /// </summary>
        /// <param name="info">存在有关所引发异常的序列化的对象数据</param>
        /// <param name="context">包含有关源或目标的上下文信息</param>
        public GameFrameworkException(SerializationInfo info, StreamingContext context)
                : base(info, context) { }
    }
}
