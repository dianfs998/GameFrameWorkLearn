...
namespace GameFrameWork
{
    ...
    /// <summary>
    /// 封装一个方法，该方法具有一个参数，并返回TResult参数指定的类型的值
    /// </summary>
    /// <typeparam name="T">此委托封装的方法的参数类型</typeparam>
    /// <typeparam name="TResult">此委托封装的方法的返回值类型</typeparam>
    /// <returns>此委托封装的方法的返回值</returns>
    public delegate TResult GameFrameworkFunc<in T, out TResult>();

    /// <summary>
    /// 封装一个方法，该方法具有两个参数，并返回TResult参数指定的类型的值
    /// </summary>
    /// <typeparam name="T1">此委托封装的方法的第一个参数类型</typeparam>
    /// <typeparam name="T2">此委托封装的方法的第二个参数类型</typeparam>
    /// <typeparam name="TResult">此委托封装的方法的返回值类型</typeparam>
    /// <returns>此委托封装的方法的返回值</returns>
    public delegate TResult GameFrameworkFunc<in T1, in T2, out TResult>();
