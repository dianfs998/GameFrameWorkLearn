...
namespace GameFrameWork.Debugger
{
    internal partial class DebuggerManager
    {
        ...
        private sealed class DebuggerWindowGroup : IDebuggerWindowGroup
        {
            ...
            /// <param name="realElpaseSeconds">真实流逝时间，以秒为单位</param>
            public void OnUpdate(float elapseSeconds, float realElpaseSeconds)
            {
                SelectedWindow.OnUpdate(elapseSeconds, realElpaseSeconds);
            }
            ...
            public void RegisterDubuggerWindow(string path, IDebuggerWindow debuggerWindow)
            {
