...
namespace GameFrameWork
{
    public static partial class Utility
    {
        public static class Converter
        {
            ...
            /// <param name="startIndex">value内的起始位置，默认为初始位置</param>
            /// <returns>如果value中指定位置的字节非零，则为true，否则为false</returns>
            ...
            /// </summary>
            /// <param name="value">字节数组</param>
            /// <param name="startIndex">value内起始位置，默认为初始位置</param>
            ...
            /// <summary>
            /// 返回由字节数组中指定位置的四个字节转换来的单精度浮点值
            /// </summary>
            /// <param name="value">字节数组</param>
            /// <param name="startIndex">value内起始位置，默认为初始位置</param>
            /// <returns>由四个字节构成的单精度浮点值</returns>
            ...
            /// <summary>
            /// 返回由字节数组中指定位置的八个字节转换来的双精度浮点值
            /// </summary>
            /// <param name="value">字节数组</param>
            /// <param name="startIndex">value内起始位置，默认为初始位置</param>
            /// <returns>由八个字节构成的双精度浮点值</returns>
